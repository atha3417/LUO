...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'test_started' => \App\Http\Middleware\IsTestStarted::class,
        'test_not_ended' => \App\Http\Middleware\IsTestNotEnded::class,
        'no_test_in_progress' => \App\Http\Middleware\IsNoTestInProgress::class,
        'not_expired' => \App\Http\Middleware\IsTestNotExpired::class,
